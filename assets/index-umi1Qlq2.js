...
aut aut aut maxime quia temporibus ut omnis`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=({comment:{name:e,email:t,body:i}})=>R.jsxs("div",{className:"CommentInfo",children:[R.jsxs("div",{className:"CommentInfo__title",children:[R.jsx("strong",{className:"CommentInfo__name",children:e})," by ",R.jsx("a",{className:"CommentInfo__email",href:`mailto:${t}`,children:t})]}),R.jsx("div",{className:"CommentInfo__body",children:i})]}),Lc=({comments:e})=>e.length>0?R.jsx("div",{className:"CommentList",children:e.map(t=>R.jsx(Pc,{comment:t},t.id))}):R.jsxs(R.Fragment,{children:[R.jsx("hr",{}),R.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"})]}),Tc=({user:{email:e,name:t}})=>R.jsx("a",{className:"UserInfo",href:`mailto:${e}`,children:t}),Mc=({post:{title:e,user:t,body:i,comments:n}})=>R.jsxs("div",{className:"PostInfo",children:[R.jsxs("div",{className:"PostInfo__header",children:[R.jsx("h3",{className:"PostInfo__title",children:e}),R.jsxs("p",{children:[" Posted by  ",R.jsx(Tc,{user:t})]})]}),R.jsx("p",{className:"PostInfo__body",children:i}),R.jsx(Lc,{comments:n})]}),Rc=({posts:e})=>R.jsx("div",{className:"PostList",children:e.map(t=>R.jsx(Mc,{post:t},t.id))});function Dc(e){return Nc.find(t=>t.id===e)}function jc(e){return zc.filter(t=>t.postId===e)}const Oc=Cc.map(e=>({...e,user:Dc(e.userId),comments:jc(e.id)})),Fc=()=>R.jsxs("section",{className:"App",children:[R.jsx("h1",{className:"App__title",children:"Static list of posts"}),R.jsx(Rc,{posts:Oc})]});em(document.getElementById("root")).render(R.jsx(Fc,{}));
